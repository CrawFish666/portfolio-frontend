...
- [ ] **Адаптив Dashboard** — проверить и доработать отображение всех страниц и компонентов админ-панели на мобильных устройствах и планшетах
  - DashboardLayout и навигация
  - таблицы и списки
...
- [ ] **Favicon** — заменить стандартную иконку сайта на собственную
